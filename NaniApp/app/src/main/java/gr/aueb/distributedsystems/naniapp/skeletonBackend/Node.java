...
/*
The Base Node Class for Implementation of dataNode
and of course for the storage of Broker and the Publisher 
nad Customer linked through the Zookeeper Class*/
 ...
 //Broker Addresses (ip, port)
    static public final ArrayList<Address> BROKER_ADDRESSES = new ArrayList<>(Arrays.asList(
            ...
            new Address("192.168.1.4", 8000)));
             ...
             //DataNode Addresses (ip, port)
    static public final ArrayList<Address> DATANODE_ADDRESSES = new ArrayList<>(Arrays.asList(
